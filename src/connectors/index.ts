...
import type { PromptElement } from '../PromptStorage'
...
export interface ActionFuncs<Parameters, O extends Outputs> {
  gen: GenFunc<O>
...
export function typedActionFuncs<Parameters, O extends Outputs>(): ActionFuncs<
  Parameters,
  O
> {
  return {
...
export function createLLM(func: LLMCompletionFn, isChat: boolean) {
  const llmWrapped = <
